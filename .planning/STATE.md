...
2026-08-11 owner directives logged: (1) JPM owner-ordered sale tonight (needs Gateway; owner_close CLI to build+run); (2) $600 nightly new-entry budget LIVE; (3) fortnightly KPI: report >=5 profitable sells per fortnight -- tracked and reported honestly, NEVER hit by forcing early exits (quota-selling guts tested edges); (4) crypto buys blocked by evidence, not neglect: 30 crypto configs killed OOS across 2 sweeps; next crypto paths = 4h timeframe evidence + scanner-ride test

2026-08-14: 4H EVIDENCE COMPLETE -- 192 tune + 15 OOS runs, ALL 15 KILLED (PF 0.01-0.58, Sharpe -0.9 to -5.6). Crypto tally: daily 0, 1h 0/20, 4h 0/15 survivors -- the Bollinger-fade and squeeze entry families lose after costs at EVERY tested speed on crypto. No crypto strategy deploys. Live crypto activity = owner snipe experiment only (segregated, $25/hourly, expected -8%/trade per the 245-snipe study). Remaining honest crypto paths: regime-gated variants, different entry families, or accept crypto stays out pending a real edge.
